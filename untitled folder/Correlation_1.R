...
mydata <- read.csv('/Users/chiranjibighimire/Desktop/CS\ 522-Bank_Project/bank-additional-full.csv', sep = ';')
...
################# Subset Selection #################
mydata_sub <-mydata[, c(1:4,7:14,15,17,21)]
str(mydata_sub)
...
mydata_sub$age <- cut(mydata_sub$age, c(1,20,40,60,100,120))
